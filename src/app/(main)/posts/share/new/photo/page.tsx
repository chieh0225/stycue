...
export default function NewSharePostPhotoPage() {
  ...
  return (
    <div className="flex flex-1 flex-col">
      <div className="flex items-center justify-between bg-surface-soft px-4 py-4">
        <Link href="/posts/share/new" className="text-label-md text-text-muted">
          返回
        </Link>
      ...
      <div className="flex flex-1 flex-col gap-4 p-6">
        <button
          ...
          className="flex h-13 w-full cursor-pointer items-center justify-center gap-2 rounded-lg border border-dashed border-border-dashed bg-muted disabled:cursor-not-allowed disabled:opacity-50"
        >
              ...
              <div className="min-w-0 flex-1">
                <div className="mb-2.5 flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="flex-shrink-0 cursor-pointer rounded-md p-1 text-text-placeholder hover:bg-accent"
                  >
                ...
                <div className="relative mb-2.5 cursor-pointer rounded-lg border border-border-default bg-muted">
                  <button
                    ...
                    className="flex h-9.5 w-full cursor-pointer items-center justify-between px-2.5 disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    <span className="text-label-md font-semibold text-text-primary">
                      {categoryLabel(image.category)}
                    </span>
